...
public record QuadraticEquationDistractor(SymbolicNumberFraction x_1, SymbolicNumberFraction x_2, QuadraticSolutionImpact impact) implements QuadraticEquationSolution {
