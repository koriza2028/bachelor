...
public interface QuadraticInequalitySolution {
	...
	public static QuadraticInequalitySolution createEmptySetSolution(boolean correct, QuadraticSolutionImpact solutionImpact) {
	...
	public static QuadraticInequalitySolution createRSolution(boolean correct, QuadraticSolutionImpact solutionImpact) {
	...
	public  static QuadraticInequalitySolution createRExceptZeroSolution(SymbolicNumberFraction root, boolean correct, QuadraticSolutionImpact solutionImpact) {
	...
	public static QuadraticInequalitySolution createOnlyZeroSolution(SymbolicNumberFraction root, boolean correct, QuadraticSolutionImpact solutionImpact) {
	...
	public static QuadraticInequalitySolution createNormalSolution(final QuadraticInequalityRange range_1, final QuadraticInequalityRange range_2, boolean correct, QuadraticSolutionImpact solutionImpact) {
		return correct ? 
