...
public class AbcSolutionServiceTest {
	...
	void testSolveCorrectlyOther() {
		...
		final var nom = new SymbolicNumber.SymbolicNumberBuilder().withFractionPart(new Fraction(2, 3)).build();
		final var denom = new SymbolicNumber.SymbolicNumberBuilder().withFractionPart(new Fraction(8, 15)).build();
	...
	void testSolveCorrectlyOtherOther() {
		...
		final var x_1 = new SymbolicNumber.SymbolicNumberBuilder().withFractionPart(frac).withRoot(root).build();
		final var x_2 = new SymbolicNumber.SymbolicNumberBuilder().withFractionPart(frac).withRoot(minusRoot).build();
